    ...
    <div class="max-w-6xl px-4 mx-auto sm:px-6 lg:px-8">
      <div class="p-6 bg-white rounded-lg shadow">
        ...
        <div v-if="service" class="space-y-4">
          ...
          <p><strong>Status:</strong> <span :class="service.status === 'active' ? 'text-green-600' : 'text-red-600'">{{ service.status }}</span></p>
          <p><strong>Created At:</strong> {{ formatDate(service.created_at) }}</p>
          <button 
