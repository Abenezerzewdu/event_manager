    ...
    <div class="min-h-screen py-8 bg-gradient-to-br from-blue-50 to-indigo-100">
        <div class="max-w-6xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-8 text-center">
                <div
                    class="inline-flex items-center justify-center w-16 h-16 mb-4 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl"
                >
                ...
                <div class="p-4 bg-white rounded-lg shadow">
                    <div class="flex items-center">
                        <div class="p-3 bg-green-100 rounded-full">
                            <i
                                class="text-green-600 fa-solid fa-check-circle"
                            ></i>
                        </div>
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-600">
                ...
                <div class="p-4 bg-white rounded-lg shadow">
                    <div class="flex items-center">
                        <div class="p-3 bg-yellow-100 rounded-full">
                            <i
                                class="text-yellow-600 fa-solid fa-dollar-sign"
                            ></i>
                        </div>
                        <!-- <div class="ml-4">
                ...
                >
                    <div class="w-full md:w-1/3">
                        <div class="relative">
                            ...
                            >
                                <i
                                    class="text-gray-400 fa-solid fa-magnifying-glass"
                                ></i>
                            </div>
                            <input
                                v-model="searchQuery"
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-start justify-between mb-4">
                            <div>
                                ...
                                <span
                                    class="inline-block px-2 py-1 mt-1 text-xs font-medium text-indigo-800 bg-indigo-100 rounded-full"
                                >
                                    {{ service.category }}
                                </span>
                            </div>
                        ...
                        <!-- Service Meta -->
                        <div
                            class="flex items-center justify-between pt-4 mt-4 text-sm text-gray-500 border-t border-gray-200"
                        >
                            <div class="flex items-center">
                                <i
                                    class="mr-1 text-gray-400 fa-solid fa-calendar"
                                ></i>
                                <span>{{
            ...
            <div v-if="services.length > 9" class="flex justify-center mt-8">
                <div class="flex space-x-2">
                    <button
                        class="px-3 py-1 text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-50"
                    >
                        <i class="fa-solid fa-chevron-left"></i>
                    </button>
                    <button
                        class="px-3 py-1 text-white bg-blue-500 border border-blue-500 rounded-lg"
                    >
                        1
                    </button>
                    <button
        ...
        <div v-if="showAddModal" class="fixed inset-0 z-50 overflow-y-auto">
            ...
            >
                ...
                <div
                    class="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white rounded-lg shadow-xl sm:align-middle sm:max-w-lg"
                >
