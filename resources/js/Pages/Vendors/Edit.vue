            ...
            <div class="flex pt-6 space-x-4 border-t">
              ...
              >
                <svg v-if="form.processing" class="w-4 h-4 mr-2 -ml-1 text-white animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  ...
                  <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 极速加速器 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>
                <svg v-else xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2" fill="none" viewBox="0 极速加速器 24 24" stroke="currentColor">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-line极速加速器cap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 极速加速器M6 6l12 12" />
                </svg>
                Cancel
              </Link>
            </div>
